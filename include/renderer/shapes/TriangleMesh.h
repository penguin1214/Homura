...
namespace Homura {
	struct Triangle {
		...
		inline bool intersect(const Ray &r, Point3f p0, Point3f p1, Point3f p2, const Vec3f &n0, const Vec3f &n1, const Vec3f n2, float &hitt, IntersectInfo &isect_info, bool smooth) const;
		//inline bool intersectP(const Ray &r, Point3f p0, Point3f p1, Point3f p2) const;
		inline bool intersectP(const Ray &r, Point3f p0, Point3f p1, Point3f p2, float &hitt) const;
